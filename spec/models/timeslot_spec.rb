...
feature "Detect overlapping time - " do
  ...
  scenario "Times do not overlap" do
    ts1 = Timeslot.new({start_time: DateTime.new(2015,1,1,9,0,0), 
      end_time: DateTime.new(2015,1,1,10,0,0), recording_session_date: "12/01/2015"})
    ts2 = Timeslot.new({start_time: DateTime.new(2015,1,1,15,0,0),
      end_time: DateTime.new(2015,1,1,16,0,0), recording_session_date: "12/01/2017"})
  ...
  scenario "Times do overlap" do
    ts1 = Timeslot.new({start_time: DateTime.new(2015,1,1,9,0,0), 
      end_time: DateTime.new(2015,1,1,10,0,0), recording_session_date: "12/01/2015"})
    binding.pry
    ts2 = Timeslot.new({start_time: DateTime.new(2015,1,1,9,30,0),
      end_time: DateTime.new(2015,1,1,10,0,0), recording_session_date: "12/01/2015"})
